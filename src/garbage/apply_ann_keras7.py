...
if __name__ == '__main__':
    ...
    train_id, train_data, train_loss = src.data_reader.train_data_reader7()

    print 'Loading test data'
    test_id, test_data = src.data_reader.test_data_reader7()
    ...
    for i, (train_index, test_index) in enumerate(kf):
        ...
        m.save('{}/fold-{}.h5'.format(subdir, i))

    predict_res /= float(n_folds)

    src.data_export.save_submission_ann(test_id, predict_res, '{}-avg'.format(run))
